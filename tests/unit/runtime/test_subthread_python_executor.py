...
from src.runtime.subthread_python_executor import run_structured_in_thread  




def test_tkinter_in_subthread():
...
print('开始测试 tkinter 在子线程中的运行情况...')
print('__name__ = ', __name__)
if __name__ == "__main__":
    asyncio.run(main())
"""
    result = run_structured_in_thread(plt_code, _globals={'__name__':'__main__'},  timeout=60*10)
    print('----------- 子线程执行结果 -----------')
    print(result)
